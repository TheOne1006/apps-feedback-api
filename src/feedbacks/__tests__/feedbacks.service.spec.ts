...
import { FeedbacksService, FeedbackFile } from '../feedbacks.service';
...
describe('FeedbacksService', () => {
  ...
  describe('createFeedback', () => {
    it('should create feedback successfully', async () => {
      const dto = { content: 'Test feedback', appName: 'TestApp', device_id: 'device-123' };
    ...
    it('should append to existing JSON file', async () => {
      const dto = { content: 'New feedback', appName: 'TestApp', device_id: 'device-123' };
      const existingData: FeedbackFile = {
        device_id: 'device-123',
        feedbacks: [{ id: 'old-id', content: 'Old', appName: 'TestApp', images: [], created_at: '2020-01-01' }]
      };
